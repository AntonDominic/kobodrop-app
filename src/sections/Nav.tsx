       ...
       <>
        <div className="flex h-[15vh] max-w-7xl items-center justify-between px-8 xl:m-auto lg:px-12">
          <div className="flex">
            <ButtonLink 
            href="#" 
            children={<img src={Kobodrop}
            alt="Kobodrop logo"/>} 
            />
            <div className="ml-4 hidden sm:flex items-center space-x-4 sm:ml-6 lg:ml-8 lg:space-x-8">
          ...
          <ButtonLink 
                ...
                className="active:bg hidden bg-gray-800 text-white rounded-xl px-5 py-3 hover:bg-gray-900 active:bg-gray-600 sm:flex"
          />  

          
          <DisclosureButton 
          className="sm:hidden rounded-md p-2 text-gray-500 hover:bg-gray-700 hover:text-white">
            {open ? (
